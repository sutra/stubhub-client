...
public class DealConfigHurdleResponse {
	...
	private List<BuyerCommissionResponse> purchasersCommissions;
	...
	public List<BuyerCommissionResponse> getPurchasersCommissions() {
		return purchasersCommissions;
	}

	public void setPurchasersCommissions(List<BuyerCommissionResponse> purchasersCommissions) {
